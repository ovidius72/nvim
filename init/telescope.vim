...
" nnoremap <leader><leader>f <cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown({ winblend = 10 }))<cr>
...
" nnoremap <leader><leader>i <cmd>lua require('telescope.builtin').file_browser()<cr>
...
" nnoremap <leader><leader>c <cmd>lua require('telescope.builtin').commankkds()<cr>
