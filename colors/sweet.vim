...
let g:colors_name='sweet.vim'
set background=dark


if ! exists("g:sweet_termcolors")
  let g:sweet_termcolors=256
endif

" not all terminals support italics properly.  If yours does, opt-in.
if ! exists("g:sweet_terminal_italics")
  let g:sweet_terminal_italics = 0
endif

" Colors
let s:black           = { "gui": "#161925", "cterm": "0", "cterm16" : "8" }
let s:medium_gray     = { "gui": "#5a606d", "cterm": "243", "cterm16" : "243" }
let s:white           = { "gui": "#dcdfe4", "cterm": "15", "cterm16" : "15" }
let s:actual_white    = { "gui": "#c3c7d1", "cterm": "231", "cterm16" : "231" }
let s:light_black     = { "gui": "#282c34", "cterm": "8", "cterm16" : "0" }
let s:lighter_black   = { "gui": "#828996", "cterm": "240", "cterm16" : "240" }

" lighter shadows and darker grays
let s:subtle_black  = { "gui": "#303030", "cterm": "236", "cterm16" : "236" }
let s:light_gray    = { "gui": "#515a6a", "cterm": "249", "cterm16" : "249" }
let s:lighter_gray  = { "gui": "#828996", "cterm": "251", "cterm16" : "251" }


" flat colors:
let s:asphalt = { "gui": "#1e1c31", "cterm": "233", "cterm16": "NONE"}
let s:asphalt_subtle= { "gui": "#100E23", "cterm": "232", "cterm16": "0"}
let s:dark_asphalt = { "gui": "#282c34", "cterm": "236", "cterm16": "8"}

let s:red = { "gui": "#ed254e", "cterm": "204", "cterm16": "1"}
let s:dark_red = { "gui": "#ed254e", "cterm": "203", "cterm16": "9"}

let s:green = { "gui": "#71f79f", "cterm": "120", "cterm16": "2"}
let s:dark_green = { "gui": "#71f79f", "cterm": "119", "cterm16": "10"}

let s:yellow = { "gui": "#f9dc5c", "cterm": "228", "cterm16": "3"}
let s:dark_yellow = { "gui": "#f9dc5c", "cterm": "215", "cterm16": "11"}

let s:blue = { "gui": "#7cb7ff", "cterm": "159", "cterm16": "4"}
let s:dark_blue = { "gui": "#7cb7ff", "cterm": "75", "cterm16": "12"}

let s:purple = { "gui": "#c74ded", "cterm": "141", "cterm16": "5"}
let s:dark_purple = { "gui": "#c74ded", "cterm": "135", "cterm16": "13"}

let s:cyan = { "gui": "#00c1e4", "cterm": "122", "cterm16": "6"}
let s:dark_cyan = { "gui": "#00c1e4", "cterm": "121", "cterm16": "14"}

let s:clouds = { "gui": "#76839a", "cterm": "253", "cterm16": "7"}
...
function! s:h(group, style)
  " Not all terminals support italics properly. If yours does, opt-in.
  if g:sweet_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:sweet_termcolors == 16
